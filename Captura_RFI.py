...
class Captura_RFI(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frec_inicial = frec_inicial = 70000000
        ...
        self.uhd_usrp_source_1.set_gain(70, 0)
        ...
        self.Control_Frecuencia = Control_Frecuencia.blk(frec_inicial=frec_inicial, frec_final=frec_final, intervalo_tiempo=0.2, ancho_banda=samp_rate_0)
        self.CSV = CSV.CSVWriterBlock(filename=r"C:\Users\dfgom\OneDrive\Escritorio\USRP\RFI_Captura\Salida\CSV_Salida.csv")
        ...
        self.connect((self.blocks_nlog10_ff_0, 0), (self.CSV, 0))
